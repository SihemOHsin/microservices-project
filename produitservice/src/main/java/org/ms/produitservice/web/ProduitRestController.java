 ...
 * 
 * @RestController public class ProduitRestController {
 * 
 * @GetMapping("/config") public Map<String, Object> config() { Map<String,
 * Object> params = new Hashtable<>(); params.put("threadName",
 * Thread.currentThread().toString()); return params; } }
 */
package org.ms.produitservice.web;
